...
#
# File    : test1.mk   $Revision: 1.81.4.35 $
#
# Abstract:
...
MAKECMD         = D:/hirain/software/Matlab2017/APP/bin/win64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                = test1
MODULES              = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             = test1.mk
MATLAB_ROOT          = D:/hirain/software/Matlab2017/APP
MATLAB_BIN           = D:/hirain/software/Matlab2017/APP/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = C:/Users/Administrator/Desktop/simpoletest
S_FUNCTIONS          = gvar_get.c gvar_set.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 0
COMPUTER             = GLNX86
BUILDARGS            =  ISPROTECTINGMODEL=NOTPROTECTING RELATIVE_PATH_TO_ANCHOR=.. MAT_FILE=1
MULTITASKING         = 0
EXT_MODE             = 0
...
#%.o : D:/hirain/AutoTest/Simpole/SimpoleSystem/ShareMemoryBlockset/%.c
#	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
#	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
#%.o : $(MATLAB_ROOT)/rtw/c/src/%.c
#	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
...
#%.o : D:/hirain/AutoTest/Simpole/SimpoleSystem/ShareMemoryBlockset/%.cpp
#	@$(GCC_TEST_CMD) "$<" $(GCC_TEST_OUT)
#	$(CPP) -c $(CPPFLAGS) "$<"
