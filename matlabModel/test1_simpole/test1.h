...
typedef struct {
  real_T SharedMemoryGet;              /* '<Root>/Shared Memory Get' */
  real_T SharedMemoryGet1;             /* '<Root>/Shared Memory Get1' */
} B_test1_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  int_T SharedMemoryGet_IWORK[3];      /* '<Root>/Shared Memory Get' */
  int_T SharedMemorySet_IWORK[3];      /* '<Root>/Shared Memory Set' */
  int_T SharedMemoryGet1_IWORK[3];     /* '<Root>/Shared Memory Get1' */
  int_T SharedMemorySet1_IWORK[3];     /* '<Root>/Shared Memory Set1' */
} DW_test1_T;
