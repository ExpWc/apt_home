...
LIBMWSF_RUNTIME_API void sf_mex_dividebyzero_error(void);
...
LIBMWSF_RUNTIME_API void      ssMessageSend_wrapper(SimStruct* S, int outputPortNum, void* payload);
LIBMWSF_RUNTIME_API void      ssMessageSendLocal_wrapper(SimStruct* S, int queueId, void* payload);
