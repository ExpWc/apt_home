...
%
blkStruct.Name = ['SharedMemory' sprintf('\n') 'Library'];

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'SharedMemory';
...
%
Browser.Library = 'SimpoleSystem';%自己新建的存放子模型的library的名称
Browser.Name    = 'SimpoleSystem';%在simulink Browser中显示的库名
